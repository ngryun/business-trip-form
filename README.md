...
사이드패널에서 식비의 지급받은 금액을 `2식`, `20,000원`, `지급 없음` 등 자유 텍스트로 작성하고, 총 동승자수와 동승자 4명의 소속·성명을 편집할 수 있습니다. 갈 때·올 때 운임의 **행 삭제 / 행 복원** 버튼은 미리보기와 출력 문서의 해당 행을 삭제·복원합니다. 입력값과 행 삭제 상태는 임시 저장 및 URL 공유에도 포함됩니다.
